...
//        return NO;
//    }
//    NSString *time = [DateTools stringWithDetailFormatterFromDate:date == nil ? [NSDate date] : date];
...
//    NSString *str = [DateTools stringFromDate:today withFormat:yyyyMMdd];
//    str = [str stringByAppendingString:@" 00:00:00"];
//    NSLog(@"%@",str);
//    today = [DateTools dateFromString:str withFormat:yyyyMMddHHmmss];
//
//    NSMutableArray *muarray = [NSMutableArray array];
//    while ([set next]) {
//        NSDictionary *result = [set resultDictionary];
